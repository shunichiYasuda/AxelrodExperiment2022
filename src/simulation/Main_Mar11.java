...
public class Main_Mar11 {
	...
	static String memo = "交叉確率平均10個体,突然変異：個体1/2,遺伝子座3カ所"; //実験記録に付けるメモ
...
//				int gtype = countGtypeBasedTFT();
//				if(gtype!=0) {
//					System.out.println("gTypeTFT="+gtype);
//				}
	...
	private static void crossover() {
		...
		for (int m = 0; m < parentsChrom.size() - 1; m += 2) {
			...
			//if(bingo(1.0/20.0)){ //個体数20で1/20の確率だから、各世代平均1個体
